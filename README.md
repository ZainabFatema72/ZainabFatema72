...
public class Developer {
    ...
    String   education     = "MCA | CGPA 8.26/10";
    int      liveSystems   = 5;     // shipped to production
    int      perfGainPct   = 30;    // API response time improved

    String[] backendStack  = { "Java", "Spring Boot", "Hibernate", "REST APIs", "JWT", "Node.js" };
    String[] frontendStack = { "React.js", "JavaScript", "Tailwind CSS", "Vite", "HTML5", "CSS3" };
    String[] dataLayer     = { "MySQL", "MongoDB", "Firebase" };
    String[] toolchain     = { "Docker", "Git", "Postman", "Maven", "Jenkins" };
    String[] nextUp        = { "Microservices", "Kafka", "Kubernetes", "AWS", "System Design" };

    boolean  openToWork    = true;
    boolean  willRelocate  = true;
    String   motto         = "Ship it, don't just demo it.";
}
```
...
- 3 consultation modes — Online, Home Visit, Clinic
...
- Multi-event support, attendee management
...
MVC Architecture · J2EE · Microservices · REST & SOAP APIs · System Design
```
